...
// REMOVED /** 
// REMOVED  * @brief Adding the mpi buffer to ChdbTest1 (doubles for time only)
// REMOVED  * 
// REMOVED  */
// REMOVED SchedTestDbl::SchedTestDbl(): ChdbTest1() {
// REMOVED     expected_values.push_back(3.14);
// REMOVED     expected_values.push_back(5.28);
// REMOVED     expected_values.push_back(7.98);
// REMOVED     double v[]={3.0,3.14,5.28,7.98};
// REMOVED     string b((char*)v,4*sizeof(double));
// REMOVED     expected_bfr = b;
// REMOVED     
// REMOVED     bfr_len  = 4*sizeof(double);
// REMOVED     bfr = malloc(bfr_len);
// REMOVED }
